...
public class ModDataComponents {
    public static final RegistryEntry<DataComponentType<?>, DataComponentType<TransmogAppearanceItem>> TRANSMOG_APPEARANCE_ITEM = ModRegistries.DATA_COMPONENT_TYPES.register(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "appearance_item"), () -> DataComponentType.<TransmogAppearanceItem>builder().persistent(TransmogAppearanceItem.CODEC).networkSynchronized(TransmogAppearanceItem.STREAM_CODEC).build());
